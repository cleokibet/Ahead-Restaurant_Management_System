...
DATABASES = {
    'default': {
        ...
        # 'NAME': 'Calinary Control',  # name of the database
        # 'USER': 'root',
        # 'PASSWORD': '',
        # 'HOST': 'localhost',
        # 'PORT': '3306',
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'cleokibet@gmail.com'   # enter you email address
EMAIL_HOST_PASSWORD = 'Cleo@25317858'     # enter your password 
